			...
			<div className="w-[90%] md:w-[65%] grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-32">
				...
				<div className="flex flex-col">
					<div className="flex justify-between items-center mb-3">
						<a
							href="https://hashnode.com/@Abdikhafar"
							target="_blank"
							rel="noreferrer"
							title="Hashnode"
						...
						<a
							href="https://dev.to/abdikhafarhub"
							target="_blank"
							rel="noreferrer"
							title="Dev.to"
							className="text-5xl font-semibold hover:scale-110 transition ease-in-out duration-200"
						...
						<a
							href="https://medium.com/@abdikhafarissack"
							target="_blank"
							rel="noreferrer"
							title="Medium"
							className="text-5xl font-semibold hover:scale-110 transition ease-in-out duration-200"
