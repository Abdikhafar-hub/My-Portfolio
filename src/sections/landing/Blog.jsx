	...
	const blogData = [
		{
			...
			title: "React.JS: Let's Build Robust Web Applications with React.",
			subtitle:
			...
			url: "https://react101.hashnode.dev/lets-build-robust-web-applications-with-react",
		},
		{
			imgUrl:
			...
			url: "https://dev.to/abdikhafarhub/python-from-the-word-go-46el",
		},
		{
			imgUrl:
			...
			url: "https://mastering-the-art-of-web-design.hashnode.dev/mastering-the-art-of-web-design",
		},
	];
	return (
		<motion.div
